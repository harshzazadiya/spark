...
def user_dashboard():
    ...
    with tabs[0]:
        ...
        with col2:
            if st.button("🔄 Refresh", key="refresh_user_history", use_container_width=True):
                st.rerun()
    ...
    with tabs[5]:  
        ...
        col1, col2 = st.columns([3, 1])
        with col2:
            if st.button("🔄 Refresh", key="refresh_parking_grid", use_container_width=True):
                st.rerun()
...
def admin_dashboard():
    ...
    elif main_nav == "📊 History":
        st.subheader("📜 Parking History")
        
        # Add refresh button
        col1, col2 = st.columns([3, 1])
        with col2:
            if st.button("🔄 Refresh", key="refresh_admin_history", use_container_width=True):
                st.rerun()
